...
export async function generateMetadata({
  ...
  const description = `Compare the top ${count} APIs in ${cat?.frontmatter.title ?? category} with pricing, auth type, and links to docs.`;
      ...
      <Container>
        ...
        <div className="flex flex-col gap-2">
          ...
          <p className="max-w-3xl text-zinc-600 dark:text-zinc-300">
            A comparison view generated from structured frontmatter (pricing, auth, docs links).
          </p>
        </div>
              ...
              <tbody>
                {apis.map((a) => (
                  <tr key={a.slug} className="border-t border-zinc-200 dark:border-zinc-800">
                    ...
                    <td className="px-4 py-3">
                      <a href={a.frontmatter.docs_url} className="hover:underline">
                        Docs
                      </a>
                    </td>
                  </tr>
                ...
                {!apis.length ? (
                  <tr>
                    <td className="px-4 py-8 text-sm text-zinc-600 dark:text-zinc-300" colSpan={5}>
